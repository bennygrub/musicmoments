...
class MomentsControllerTest < ActionController::TestCase
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post :create, moment: { friends: @moment.friends, name: @moment.name, season: @moment.season, song: @moment.song, year: @moment.year }
    end
  ...
  test "should update moment" do
    put :update, id: @moment, moment: { friends: @moment.friends, name: @moment.name, season: @moment.season, song: @moment.song, year: @moment.year }
    assert_redirected_to moment_path(assigns(:moment))
  end
